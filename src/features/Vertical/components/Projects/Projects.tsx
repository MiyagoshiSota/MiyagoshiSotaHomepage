      ...
      <div className={styles.cards}>
        ...
        <div className={styles.scroll_items}>
          <ul className={styles.first}>
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/1jk6musspzt"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/xdh2qj-pj"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/z4pv2lt3vz"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/xhrp142x5"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/3dreuvz20zlz"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/4_387vcrz1"
        ...
        <div className={styles.scroll_items}>
          <ul className={styles.second}>
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/dey2hhqr03op"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/eogme3crobw"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/7ylf319lwy"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/psi04-20go"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/vvbohc5u2v"
            ...
            <li className={styles.scroll_item}>
              <ProductCard
                url="https://miyagoshi-sota-git-main-miyagoshis-projects.vercel.app/posts/r9vhgcts-o"
